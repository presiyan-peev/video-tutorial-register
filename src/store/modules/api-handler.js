...
export default {
  state: {
    courses: [
        { title: "Angular", description: "Lorem ipsum", imageUrl: "https://cdn.worldvectorlogo.com/logos/angular-icon.svg", isPublic: true, "lectures": [], usersEnrolled: [], usersEnrolledCount: 21, lecturesCount: 3 },
